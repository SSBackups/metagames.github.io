var unityFramework = (() => {
    ...
    return (
        function(unityFramework = {}) {
            ...
            function _AddAudioEventListener() {
                this._myGlobalAudioEventListener = function(event) {
                    if (event.data.messageType == "rcp-fe-lol-home-section-show" || event.data.messageType == "rcp-fe-lol-home-show" || event.data.messageType == "rcp-fe-lol-persistent-iframe-show") {
                        SendMessage("ClientBridge", "Unmute")
                    } else if (event.data.messageType == "rcp-fe-lol-home-section-hide" || event.data.messageType == "rcp-fe-lol-home-hide" || event.data.messageType == "rcp-fe-lol-persistent-iframe-hide") {
                        SendMessage("ClientBridge", "Mute")
                    } else if (event.data.messageType == "rcp-fe-lol-home-settings-audio-response") {
                        const newSettings = event.data.data;
                        const jsonString = JSON.stringify(newSettings);
                        console.log("New audio settings: " + jsonString);
                        SendMessage("ClientBridge", "HandleClientAudioSettings", jsonString)
                    } else {
                        console.log(event)
                    }
                };
            ...
            function _AddEventListener() {
                this._myGlobalListener = function(event) {
                    const {
                    ...
                    switch (messageType) {
                        case "rcp-fe-lol-home-data-response":
                            SendMessage("ClientBridge", "SetClientData", JSON.stringify(data.clientData));
                            break;
                        case "lol-metagames-currency-balances-response":
                            SendMessage("ClientBridge", "SetMGSWalletsData", JSON.stringify(data));
                            break;
                        case "lol-metagames-player-data-response":
                            ...
                            SendMessage("ClientBridge", "SetMGSPlayerData", JSON.stringify(data.playerData.gameData));
                            break;
                        case "rcp-fe-lol-home-missions-changed":
                            let simplifiedRewardData = event.data.data.map(mission => {
                                return {
                                    internalName: mission.internalName,
                                    status: mission.status
                                }
                            });
                            SendMessage("ClientBridge", "SetMissions", JSON.stringify(simplifiedRewardData));
                            break;
                        case "lol-metagames-player-event-response":
                            SendMessage("ClientBridge", "HandlePlayerEventResponse", JSON.stringify(data));
                            break;
                        case "lol-metagames-player-data-update-response":
                            console.log("MGS Player Data Update Response: " + JSON.stringify(data));
                            SendMessage("ClientBridge", "SetMGSUpdatePlayerDataResponseFlag", JSON.stringify(data.success));
                            break;
                        case "rcp-fe-lol-home-section-show":
                        case "rcp-fe-lol-home-show":
                        case "rcp-fe-lol-persistent-iframe-show":
                            SendMessage("ClientBridge", "Unpause");
                            break;
                        case "rcp-fe-lol-home-section-hide":
                        case "rcp-fe-lol-home-hide":
                        case "rcp-fe-lol-persistent-iframe-hide":
                            SendMessage("ClientBridge", "Pause");
                            break;
                        case "league-session-token-response":
                            SendMessage("ClientBridge", "SetRCSessionToken", JSON.stringify(data));
                            break;
                        case "rcp-fe-lol-home-inventory-response":
                            SendMessage("ClientBridge", "SetEventPassOwnership", JSON.stringify(data));
                            break;
                        case "lol-metagames-get-build-version-response":
                            SendMessage("ClientBridge", "SetClientBuildVersion", JSON.stringify(data));
                            break
                    }
                };
            ...
            function _GetMGSPlayerData(gameIdentifier) {
                let convertedGameIdentifier = UTF8ToString(gameIdentifier);
                window.parent.postMessage({
                    ...
                    data: {
                        ...
                        options: {
                            "metagameId": convertedGameIdentifier
                        }
                    }
                }, "*")
            }

            function _GetRCSessionToken() {
                window.parent.postMessage({
            ...
            function _HandleLoginError() {
                ...
                document.getElementById("opal-mask-overlay").style.opacity = 1;
                window.dispatchEvent(new ErrorEvent("error", {
                    message: "Login error in Opal"
                }))
            }

            function _JSOpenPurchaseWidget(itemId, inventoryType) {
                let convertedItemId = UTF8ToString(itemId);
                let convertedInventoryType = UTF8ToString(inventoryType);
                window.parent.postMessage({
                    messageType: "rcp-fe-lol-home-open-paw",
                    type: "RClientWindowMessenger",
                    data: {
                        inventoryType: convertedInventoryType,
            ...
            function _NavigateToStoreSkins() {
                var skinIds = [111039, 234043, 3040, 516029, 360035, 233020, 234043, 51054, 147059, 22084, 78042, 350070, 115043, 876046, 164044, 157088, 55070, 126038, 950029, 19058, 235072, 113048, 53066, 50042, 223039, 711029, 82055];
                var storeItems = skinIds.map(id => {
                    return {
            ...
            function _RemoveAudioEventListener() {
                window.removeEventListener("message", this._myGlobalAudioEventListener);
                this._myGlobalAudioEventListener = null
            }

            function _RemoveEventListener() {
                window.removeEventListener("message", this._myGlobalListener);
                this._myGlobalListener = null
            }

            function _RequestClientAudioSettings() {
                window.parent.postMessage({
            ...
            function _RequestInventoryData() {
                window.parent.postMessage({
            ...
            function _RequestMGSWalletsData() {
                window.parent.postMessage({
                    messageType: "lol-metagames",
                    type: "RClientWindowMessenger",
                    data: {
            ...
            function _SendMGSPlayerEvent(gameIdentifier, eventName, eventData) {
                let convertedGameIdentifier = UTF8ToString(gameIdentifier);
                let convertedEventName = UTF8ToString(eventName);
                let eventDataObj = JSON.parse(UTF8ToString(eventData));
                window.parent.postMessage({
                    messageType: "lol-metagames",
                    type: "RClientWindowMessenger",
                    data: {
                        ...
                        options: {
                            "metagameId": convertedGameIdentifier,
                            "eventName": convertedEventName,
                            "playerGameData": eventDataObj,
				...
				{
					//Increment the amount of silvershields if this is end turn
					eventDataObj.LastSeenSilverShieldValue += 1000;
					//Save the current progress
					localStorage.setItem("demaciaRisingMinigameData", JSON.stringify(eventDataObj));
				}
				
				var silverShields = eventDataObj.LastSeenSilverShieldValue || 500;
				SendMessage("ClientBridge", "SetMGSWalletsData", `{"currency":"mgs_opal_shield","balance":${silverShields}}`);
                SendMessage("ClientBridge", "HandlePlayerEventResponse", `{"attemptedPurchase":false,"playerGameData":{"gameData":${cachedData}},"purchaseIdToObserve":""}`); 
            }

            function _UpdateMGSPlayerData(gameIdentifier, playerGameData) {
                let convertedGameIdentifier = UTF8ToString(gameIdentifier);
                let convertedPlayerGameData = UTF8ToString(playerGameData);
                window.parent.postMessage({
                    messageType: "lol-metagames",
                    type: "RClientWindowMessenger",
                    data: {
                        ...
                        options: {
                            "metagameId": convertedGameIdentifier,
                            "playerData": convertedPlayerGameData
                        }
                    }
                }, "*")
            }
            ...
            var wasmImports = {
                "Ta": _AddAudioEventListener,
                "db": _AddEventListener,
                "Md": _GetJSLoadTimeInfo,
                "Nd": _GetJSMemoryInfo,
                "_a": _GetMGSPlayerData,
                "Wa": _GetRCSessionToken,
                "O": _HandleLoginError,
                "Va": _JSOpenPurchaseWidget,
                "Zd": _JS_Accelerometer_IsRunning,
                "zb": _JS_Accelerometer_Start,
                "yb": _JS_Accelerometer_Stop,
                "na": _JS_CallAsLongAsNoExceptionsSeen,
                "de": _JS_Cursor_SetImage,
                "qa": _JS_Cursor_SetShow,
                "pa": _JS_DOM_MapViewportCoordinateToElementLocalCoordinate,
                "r": _JS_DOM_UnityCanvasSelector,
                "Id": _JS_Eval_OpenURL,
                "Fd": _JS_FileSystem_Initialize,
                "H": _JS_FileSystem_Sync,
                "Ld": _JS_GetRandomBytes,
                "Kd": _JS_Get_WASM_Size,
                ...
                "Zb": _JS_Module_WebGLContextAttributes_PowerPreference,
                "Ge": _JS_Module_WebGLContextAttributes_PremultipliedAlpha,
                "Ee": _JS_Module_WebGLContextAttributes_PreserveDrawingBuffer,
                ...
                "D": _JS_ScreenOrientation_Lock,
                "Gd": _JS_SetMainLoop,
                "ye": _JS_Sound_Create_Channel,
                "n": _JS_Sound_GetAudioBufferSampleRate,
                "m": _JS_Sound_GetAudioContextSampleRate,
                "F": _JS_Sound_GetLength,
                "se": _JS_Sound_GetLoadState,
                "xe": _JS_Sound_GetPosition,
                "qe": _JS_Sound_Init,
                "Tb": _JS_Sound_Load,
                ...
                "U": _JS_Sound_SetPaused,
                "Wb": _JS_Sound_SetPitch,
                "we": _JS_Sound_SetPosition,
                "ve": _JS_Sound_SetVolume,
                "V": _JS_Sound_Stop,
                "Rb": _JS_SystemInfo_GetBrowserName,
                "nb": _JS_SystemInfo_GetBrowserVersionString,
                "Od": _JS_SystemInfo_GetCanvasClientSize,
                "T": _JS_SystemInfo_GetDocumentURL,
                ...
                "Bc": _JS_SystemInfo_GetStreamingAssetsURL,
                "ze": _JS_SystemInfo_HasAstcHdr,
                "gb": _JS_SystemInfo_HasCursorLock,
                "wd": _JS_SystemInfo_HasFullscreen,
                "Y": _JS_SystemInfo_HasWebGL,
                "pb": _JS_SystemInfo_HasWebGPU,
                "od": _JS_UnityEngineShouldQuit,
                "Nc": _JS_WebCamVideo_GetNativeHeight,
                "Oc": _JS_WebCamVideo_GetNativeWidth,
                "Vg": _JS_WebCamVideo_GrabFrame,
                "g": _JS_WebGPU_SetCommandEncoder,
                "Xg": _JS_WebGPU_Setup,
                "Dd": _JS_WebPlayer_FinishInitialization,
                "le": _JS_WebRequest_Abort,
                "ie": _JS_WebRequest_Create,
                "je": _JS_WebRequest_GetResponseMetaData,
                "ke": _JS_WebRequest_GetResponseMetaDataLengths,
                "ra": _JS_WebRequest_Release,
                "ee": _JS_WebRequest_Send,
                "ge": _JS_WebRequest_SetRedirectLimit,
                "fe": _JS_WebRequest_SetRequestHeader,
                "he": _JS_WebRequest_SetTimeout,
                "Ua": _NavigateToStoreSkins,
                "ja": _RemoveAudioEventListener,
                "ka": _RemoveEventListener,
                "Tc": _RequestClientAudioSettings,
                "cb": _RequestClientData,
                "bb": _RequestInventoryData,
                "Xa": _RequestMGSWalletsData,
                "ab": _RequestMissionsData,
                "$a": _SelectMissionReward,
                "Za": _SendMGSPlayerEvent,
                "Ya": _UpdateMGSPlayerData,
                "$f": ___dlsym,
                "Fe": ___syscall__newselect,
                "jf": ___syscall_accept4,
                "Uf": ___syscall_bind,
                "jb": ___syscall_chmod,
                "Ff": ___syscall_connect,
                "$c": ___syscall_dup3,
                "Ad": ___syscall_faccessat,
                "Uc": ___syscall_fchmod,
                "j": ___syscall_fcntl64,
                "Rg": ___syscall_fstat64,
                "fd": ___syscall_getcwd,
                "cd": ___syscall_getdents64,
                "ad": ___syscall_getpeername,
                "vf": ___syscall_getsockname,
                "Mf": ___syscall_getsockopt,
                "Xb": ___syscall_ioctl,
                "tf": ___syscall_listen,
                "rg": ___syscall_lstat64,
                "ed": ___syscall_mkdirat,
                "Bg": ___syscall_newfstatat,
                "Ec": ___syscall_openat,
                "Jd": ___syscall_pipe,
                "wf": ___syscall_poll,
                "Vc": ___syscall_readlinkat,
                "Le": ___syscall_recvfrom,
                "Zc": ___syscall_recvmsg,
                "hd": ___syscall_renameat,
                "dd": ___syscall_rmdir,
                "_c": ___syscall_sendmsg,
                "Ue": ___syscall_sendto,
                "eb": ___syscall_socket,
                "Hg": ___syscall_stat64,
                "Tg": ___syscall_statfs64,
                "Xc": ___syscall_symlink,
                "Ug": ___syscall_truncate64,
                "nd": ___syscall_unlinkat,
                "gd": ___syscall_utimensat,
                "Hc": __emscripten_get_now_is_monotonic,
                "Vd": __gmtime_js,
                "_d": __localtime_js,
                "ae": __mktime_js,
                "Rc": __munmap_js,
                ...
                "zd": _emscripten_set_pointerlockchange_callback_on_thread,
                ...
                "W": _emscripten_webgl_enable_extension,
                ...
                "cf": _glUnmapBuffer,
                "xf": _glUseProgram,
                "Og": _glValidateProgram,
                "yf": _glVertexAttrib4f,
                "zf": _glVertexAttrib4fv,
                "We": _glVertexAttribIPointer,
                "Af": _glVertexAttribPointer,
                "za": _glViewport,
                "dh": _navigator_gpu_get_preferred_canvas_format,
                "yd": _navigator_gpu_request_adapter_async,
                "oa": _strftime,
                "Yc": _strftime_l,
                "Ra": _wgpu_adapter_or_device_get_features,
                "Sa": _wgpu_adapter_or_device_get_limits,
                "xd": _wgpu_adapter_request_device_async,
                "Jc": _wgpu_buffer_get_mapped_range,
                "Pa": _wgpu_buffer_map_async,
                "Ma": _wgpu_buffer_read_mapped_range,
                "Ic": _wgpu_buffer_unmap,
                "bh": _wgpu_canvas_context_configure,
                "ea": _wgpu_canvas_context_get_current_texture,
                "eh": _wgpu_canvas_get_webgpu_context,
                "Fc": _wgpu_command_encoder_begin_compute_pass,
                "M": _wgpu_command_encoder_begin_render_pass,
                "N": _wgpu_command_encoder_copy_buffer_to_buffer,
                "hh": _wgpu_command_encoder_copy_texture_to_buffer,
                "Kc": _wgpu_command_encoder_copy_texture_to_texture,
                "gh": _wgpu_compute_pass_encoder_dispatch_workgroups,
                "fh": _wgpu_compute_pass_encoder_dispatch_workgroups_indirect,
                "ga": _wgpu_device_create_bind_group,
                "u": _wgpu_device_create_bind_group_layout,
                "C": _wgpu_device_create_buffer,
                "f": _wgpu_device_create_command_encoder,
                "Qa": _wgpu_device_create_command_encoder_simple,
                "Gc": _wgpu_device_create_compute_pipeline,
                "t": _wgpu_device_create_pipeline_layout,
                "K": _wgpu_device_create_render_pipeline,
                "kh": _wgpu_device_create_sampler,
                "v": _wgpu_device_create_shader_module,
                "Wg": _wgpu_device_create_texture,
                "w": _wgpu_device_get_queue,
                "ih": _wgpu_device_pop_error_scope_async,
                "jh": _wgpu_device_push_error_scope,
                "ch": _wgpu_device_set_uncapturederror_callback,
                "A": _wgpu_encoder_end,
                "ia": _wgpu_encoder_finish,
                "J": _wgpu_encoder_pop_debug_group,
                "Ka": _wgpu_encoder_push_debug_group,
                "fa": _wgpu_encoder_set_bind_group,
                "l": _wgpu_encoder_set_pipeline,
                "I": _wgpu_is_valid_object,
                "e": _wgpu_object_destroy,
                "h": _wgpu_object_set_label,
                "Lc": _wgpu_pipeline_get_bind_group_layout,
                "$g": _wgpu_queue_submit_multiple_and_destroy,
                "ha": _wgpu_queue_submit_one_and_destroy,
                "q": _wgpu_queue_write_buffer,
                "Cc": _wgpu_queue_write_texture,
                "B": _wgpu_render_commands_mixin_draw,
                "Dc": _wgpu_render_commands_mixin_draw_indexed,
                "Ja": _wgpu_render_commands_mixin_draw_indexed_indirect,
                "Ia": _wgpu_render_commands_mixin_draw_indirect,
                "mh": _wgpu_render_commands_mixin_set_index_buffer,
                "Oa": _wgpu_render_commands_mixin_set_vertex_buffer,
                "Zg": _wgpu_render_pass_encoder_set_scissor_rect,
                "lh": _wgpu_render_pass_encoder_set_stencil_reference,
                "Yg": _wgpu_render_pass_encoder_set_viewport,
                "_g": _wgpu_texture_create_view,
                "La": _wgpu_texture_create_view_simple
            };
            var asm = createWasm();
            var ___wasm_call_ctors = function() {
                return (___wasm_call_ctors = Module["asm"]["ph"]).apply(null, arguments)
            };
            var _GetFakemodTimeInSeconds = Module["_GetFakemodTimeInSeconds"] = function() {
                return (_GetFakemodTimeInSeconds = Module["_GetFakemodTimeInSeconds"] = Module["asm"]["qh"]).apply(null, arguments)
            };
            var _ReleaseKeys = Module["_ReleaseKeys"] = function() {
                return (_ReleaseKeys = Module["_ReleaseKeys"] = Module["asm"]["rh"]).apply(null, arguments)
            };
            var _GetCopyBufferAsCStr = Module["_GetCopyBufferAsCStr"] = function() {
                return (_GetCopyBufferAsCStr = Module["_GetCopyBufferAsCStr"] = Module["asm"]["sh"]).apply(null, arguments)
            };
            var _getMetricsInfo = Module["_getMetricsInfo"] = function() {
                return (_getMetricsInfo = Module["_getMetricsInfo"] = Module["asm"]["th"]).apply(null, arguments)
            };
            var _SendMessageFloat = Module["_SendMessageFloat"] = function() {
                return (_SendMessageFloat = Module["_SendMessageFloat"] = Module["asm"]["uh"]).apply(null, arguments)
            };
            var _SendMessageString = Module["_SendMessageString"] = function() {
                return (_SendMessageString = Module["_SendMessageString"] = Module["asm"]["vh"]).apply(null, arguments)
            };
            var _SendMessage = Module["_SendMessage"] = function() {
                return (_SendMessage = Module["_SendMessage"] = Module["asm"]["wh"]).apply(null, arguments)
            };
            var _SetFullscreen = Module["_SetFullscreen"] = function() {
                return (_SetFullscreen = Module["_SetFullscreen"] = Module["asm"]["xh"]).apply(null, arguments)
            };
            var _main = Module["_main"] = function() {
                return (_main = Module["_main"] = Module["asm"]["yh"]).apply(null, arguments)
            };
            var _SendPasteEvent = Module["_SendPasteEvent"] = function() {
                return (_SendPasteEvent = Module["_SendPasteEvent"] = Module["asm"]["zh"]).apply(null, arguments)
            };
            var ___errno_location = function() {
                return (___errno_location = Module["asm"]["Ah"]).apply(null, arguments)
            };
            var _htonl = function() {
                return (_htonl = Module["asm"]["Bh"]).apply(null, arguments)
            };
            var _htons = function() {
                return (_htons = Module["asm"]["Ch"]).apply(null, arguments)
            };
            var _ntohs = function() {
                return (_ntohs = Module["asm"]["Dh"]).apply(null, arguments)
            };
            var _malloc = function() {
                return (_malloc = Module["asm"]["Eh"]).apply(null, arguments)
            };
            var _free = function() {
                return (_free = Module["asm"]["Fh"]).apply(null, arguments)
            };
            var _emscripten_builtin_memalign = function() {
                return (_emscripten_builtin_memalign = Module["asm"]["Gh"]).apply(null, arguments)
            };
            var ___trap = function() {
                return (___trap = Module["asm"]["Hh"]).apply(null, arguments)
            };
            var stackSave = function() {
                return (stackSave = Module["asm"]["Ih"]).apply(null, arguments)
            };
            var stackRestore = function() {
                return (stackRestore = Module["asm"]["Jh"]).apply(null, arguments)
            };
            var stackAlloc = function() {
                return (stackAlloc = Module["asm"]["Kh"]).apply(null, arguments)
            };
